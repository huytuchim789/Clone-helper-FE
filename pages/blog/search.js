...
const SearchBlog = () => {
    ...
    useEffect(() => {
        const fetchQuestion = async () => {
            ...
            try {
                const res = await publicFetch.get(`/blog?key=${router.query.key}&&page=${page}`)
    ...
    return (
        <Layout extra={false}>
            ...
            <PageTitle title={`Search Blog result for [${router.query.key}]`} button borderBottom={false} isBlog={true} />
